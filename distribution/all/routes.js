...
function routes(config) {
  ...
  function put(service, name, callback) {
    ...
    return globalThis.distribution[context.gid].comm.send([service, name], remote, callback);
  }
  ...
  function rem(configuration, callback) {
    ...
    return globalThis.distribution[context.gid].comm.send([configuration], remote, callback);
  }
